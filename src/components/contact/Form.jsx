...
export default function Form() {
  ...
  return (
    ...
    className='max-w-md w-full flex flex-col items-center justify-center space-y-4'>
      ...
      focus:ring-2 focus:ring-accent/50 custom-bg hover:border-accent'
      />
      {
      ...
      variants={item}
      value='Send'
      className='px-10 py-4 rounded-md shadow-lg border border-accent/30 border-solid
      hover:shadow-glass-sm backdrop-blur-sm text-foreground focus:outline-none focus:ring-2 focus:ring-accent/50
      cursor-pointer capitalize hover:border-accent' 
      type="submit" />
    </motion.form>
    </>
  );
