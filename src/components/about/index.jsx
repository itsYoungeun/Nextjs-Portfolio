    ...
    <section className='py-20 w-full'>
        <div className='grid grid-cols-12 gap-4 xd:gap-6 md:gap-8 w-full'>
            ...
            <ItemLayout className={'col-span-full hover:border-accent'}>
                <img className='w-full h-auto' src="https://skillicons.dev/icons?i=aws,bootstrap,codepen,cs,css,discord,express,figma,git,github,html,java,jquery,js,matlab,mongodb,nextjs,nodejs,npm,powershell,postman,py,pycharm,react,redux,regex,sass,sqlite,stackoverflow,tailwind,threejs,unity,windows,vite,vscode" alt="Youngeun" loading="lazy" />
            </ItemLayout>
