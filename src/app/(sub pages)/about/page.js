...
export default function Home() {
  return (
    <>
      ...
      <div className='absolute flex flex-col items-center text-center top-[60%] left-1/2 -translate-y-48 -translate-x-1/2'>
        <h1 className='fond-bold text-4xl text-accent'>Youngeun</h1>
